...
public class GridAdapter extends RecyclerView.Adapter<ImageViewHolder> {
     ...
     */
    public GridAdapter(Fragment fragment, RecyclerView recyclerView) {
        this.requestManager = Glide.with(fragment);
        this.viewHolderListener = new ViewHolderListenerImpl(fragment, recyclerView);
    }
    ...
    private static class ViewHolderListenerImpl implements ViewHolderListener {
        ...
        ViewHolderListenerImpl(Fragment fragment, final RecyclerView recyclerView) {
        ...
        public void onItemClicked(View view, int position) {
            ...
            List<ImageViewHolder> list = new ArrayList<>();
            for (int i = firstVisibleItem; i <= lastVisible; i++) {
                list.add((ImageViewHolder) recyclerView.findViewHolderForAdapterPosition(i));
            }
            // Update the position.
            ...
            FragmentTransaction fragmentTransaction = fragment.getFragmentManager()
                    .beginTransaction()
                    .setReorderingAllowed(true) // Optimize for shared element transition
                    .replace(R.id.fragment_container, new ImagePagerFragment(), ImagePagerFragment.class
                            .getSimpleName())
                    .addToBackStack(null);
             for (ImageViewHolder holder : list){
                    fragmentTransaction.addSharedElement(holder.image, holder.image.getTransitionName());
             }
